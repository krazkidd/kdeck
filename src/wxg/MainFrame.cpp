    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    mnuLogin = wxglade_tmp_menu->Append(ID_Login, _("Login..."), _("Login"));
    Bind(wxEVT_MENU, &MainFrame::OnMenuItemSelected, this, ID_Login);
    mnuLogout = wxglade_tmp_menu->Append(ID_Logout, _("Logout..."), _("Logout"));
    Bind(wxEVT_MENU, &MainFrame::OnMenuItemSelected, this, ID_Logout);
    wxglade_tmp_menu->AppendSeparator();
    wxglade_tmp_menu->Append(wxID_EXIT, _("~Quit~"), wxEmptyString);
    frame_menubar->Append(wxglade_tmp_menu, _("&File"));
    wxglade_tmp_menu = new wxMenu();
    wxglade_tmp_menu->Append(ID_Exchange_Announcements, _("Announcements"), _("Announcements"));
    Bind(wxEVT_MENU, &MainFrame::OnMenuItemSelected, this, ID_Exchange_Announcements);
    wxglade_tmp_menu->Append(ID_Exchange_Schedule, _("Schedule"), _("Schedule"));
    Bind(wxEVT_MENU, &MainFrame::OnMenuItemSelected, this, ID_Exchange_Schedule);
    wxglade_tmp_menu->Append(ID_Exchange_Status, _("Status"), _("Status"));
    Bind(wxEVT_MENU, &MainFrame::OnMenuItemSelected, this, ID_Exchange_Status);
    frame_menubar->Append(wxglade_tmp_menu, _("&Exchange"));
    wxglade_tmp_menu = new wxMenu();
    mnuShowClosedPositions = wxglade_tmp_menu->Append(ID_View_ShowClosedPositions, _("Show Closed Positions"), _("Show Closed Positions"));
    Bind(wxEVT_MENU, &MainFrame::OnMenuItemSelected, this, ID_View_ShowClosedPositions);
