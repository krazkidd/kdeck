...
BaseMainFrame::BaseMainFrame(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style):
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    Bind(wxEVT_MENU, &BaseMainFrame::OnMenuItemSelected, this, kdeck::ID_Login);
    ...
    Bind(wxEVT_MENU, &BaseMainFrame::OnMenuItemSelected, this, kdeck::ID_Exchange_Announcements);
    wxglade_tmp_menu->Append(kdeck::ID_Exchange_Schedule, _("Schedule"), _("Schedule"));
    Bind(wxEVT_MENU, &BaseMainFrame::OnMenuItemSelected, this, kdeck::ID_Exchange_Schedule);
    wxglade_tmp_menu->Append(kdeck::ID_Exchange_Status, _("Status"), _("Status"));
    Bind(wxEVT_MENU, &BaseMainFrame::OnMenuItemSelected, this, kdeck::ID_Exchange_Status);
...
BEGIN_EVENT_TABLE(BaseMainFrame, wxFrame)
    // begin wxGlade: BaseMainFrame::event_table
    // end wxGlade
END_EVENT_TABLE();


void BaseMainFrame::OnMenuItemSelected(wxCommandEvent &event)  // wxGlade: BaseMainFrame.<event_handler>
{
    event.Skip();
    // notify the user that he hasn't implemented the event handler yet
    wxLogDebug(wxT("Event handler (BaseMainFrame::OnMenuItemSelected) not implemented yet"));
}

void BaseMainFrame::---(wxCommandEvent &event)  // wxGlade: BaseMainFrame.<event_handler>
{
    event.Skip();
    // notify the user that he hasn't implemented the event handler yet
    wxLogDebug(wxT("Event handler (BaseMainFrame::---) not implemented yet"));
}


// wxGlade: add BaseMainFrame event handlers
